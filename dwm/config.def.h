...
static const char *fonts[]          = { "SourceCodePro-Bold:size=10" };
...
static const char *powermenu[] = { "~/MDWM/scripts/powermenu.sh", NULL };
static const char *dmenu[] = { "~/MDWM/scripts/dmenu.sh", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ ControlMask,					XK_g,	   spawn,          {.v = dmenu } },
